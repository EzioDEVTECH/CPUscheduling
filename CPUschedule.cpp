...
}ps[100];       //PANG STORE NG INFO EACH PROCESS(ARRAY STRUCTURE)  
...
int main()
{
    ...
    //PANG SORT SA PROCESS ID PARA SUNOD SUNOD YUNG NUMBER(WALA LANG TRIP KO LANG)
